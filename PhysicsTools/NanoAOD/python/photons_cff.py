...
slimmedPhotonsWithUserData = cms.EDProducer("PATPhotonUserDataEmbedder",
    ...
    userFloats = cms.PSet(
        ...
        mvaID_modified = cms.InputTag("photonMVAValueMapProducer:PhotonMVAEstimatorRunIIFall17v2modifiedValues"),
...
photonTable = cms.EDProducer("SimpleCandidateFlatTableProducer",
    ...
    variables = cms.PSet(CandVars,
        ...
        mvaID_modified = Var("userFloat('mvaID_modified')",float,doc="MVA ID score, Fall17V2, modified",precision=10),
