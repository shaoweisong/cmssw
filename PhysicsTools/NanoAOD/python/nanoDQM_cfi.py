    ...
    vplots = cms.PSet(
        ...
        Photon = cms.PSet(
            ...
            plots = cms.VPSet(
                ...
                Plot1D('mvaID_modified', 'mvaID_modified', 20, -1, 1, 'MVA ID score, modified'),
                ...
                Plot1D('chargedHadronIso', 'chargedHadronIso', 100, 0, 6, 'charged hadron isolation with dxy,dz match to pv'),
